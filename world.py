...
class PixelDrawWorld(World):
    ...
    def fill_slot_data(self) -> Mapping[str, Any]:
        return self.options.as_dict(
            "trap_chance", "death_link", "death_link_amnesty", "randomize_enemy_deaths", "randomize_compatibility_chips", "additional_compatibility_chips", "randomize_salesmen", "randomize_blueprints",
